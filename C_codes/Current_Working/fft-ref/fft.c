...
int main(int argc, char * argv[])
{
	...
	*/
	//double test[]={1,1,1,1,0,0,0,0};// this value assigned only into the
	
	double testR[]={4,1,0,1,0,1,0,1};
	double testIm[]={0,2.41,0,0.41,0,-0.41,0,-2.41};
	for(i=0;i<Nx;i++)
	{
		//X[2*i+1] = test[i]; // data[[odd][even]] the real part is [1,1,1,1,0,0,0,0]
		X[2*i+1] = testR[i];
