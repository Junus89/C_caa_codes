...
int main()
{
 ...
 /* PBD1 = make_4Ddmatrix(FNum,OSNum,BNum,DSNum);
  ...
  double complex PBD1[FNum][OSNum][BNum][DSNum];
  double complex PBD2[FNum][OSNum][BNum][DSNum];
  double complex PBD3[FNum][OSNum][BNum][DSNum];
  
  double complex PB1[FNum][OSNum][BNum];
  double complex PB2[FNum][OSNum][BNum];
  double complex PB3[FNum][OSNum][BNum];
  
  double complex P1[FNum][OSNum];
  double complex P2[FNum][OSNum];
  double complex P3[FNum][OSNum];
  
  //pF = make_dmatrix(FNum,1);
  double complex pF[FNum][1];
  double complex pXOYM[FNum][1];
  double complex Op[FNum][1];
  ...
  for(int n =0; n< FNum;n++)
  {
	  ...
	  /*complex P1[FNum][OSNum]={0};
	  complex P2[FNum][OSNum]={0};
	  complex P3[FNum][OSNum]={0};*/
